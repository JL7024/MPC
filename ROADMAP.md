...
> **自动驾驶轨迹跟踪与决策仿真系统** | Python, ROS2, cvxpy, OSQP
> - 实现基于线性化自行车模型的 MPC 控制器，cvxpy 参数化 QP + OSQP 热启动，单步求解 ~10 ms
> - 对比 PID / LQR / MPC 在直线、圆、双移线场景的跟踪性能，量化预测控制的预瞄优势
> - 集成扩展卡尔曼滤波器（EKF）融合 GPS / IMU / 轮速多频率传感器，估计误差 < 0.3 m
> - MPC 增加障碍线性化半空间约束，支持静态 / 动态避障，验证不确定性锥设计
> - A* 全局规划 + B-spline 平滑生成参考路径，与 MPC 跟踪联合验证
> - ROS2 (Humble) 多节点系统，支持 RViz2 可视化与 rosbag 回放
